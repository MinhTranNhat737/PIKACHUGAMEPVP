...
export const CHARACTERS: PixelCharacter[] = [
  {
    ...
    ultimateSkill: {
      ...
      icon: '⚡',
      energyCost: 55,
      description: 'Soi sáng toàn bộ đường nối trong 10s, giật sét đánh tan và TIÊU DIỆT 2 CẶP Pokémon (+30đ), tặng ngay +15 Gợi ý & +3 Đổi bài. PVP ĐẶC BIỆT: Phóng sét 10 Vạn Volt làm tê liệt đối thủ 3.5s, đánh sập chuỗi Combo về 0 và triệt tiêu 35% năng lượng đối thủ!',
  ...
  },
  {
    ...
    ultimateSkill: {
      ...
      icon: '☄️',
      energyCost: 65,
      description: 'Ngưng đọng thời gian 8s, lực hút Susanoo dồn nén toàn bộ quân cờ xuống đáy và nghiền nát TIÊU DIỆT 1 CẶP cờ (+25đ), dựng Khiên Hào Quang 15s. PVP ĐẶC BIỆT: Phong ấn Tsukuyomi khóa cờ đối thủ 4.5s & đảo tung toàn bộ vị trí cờ đối thủ!',
  ...
  },
  {
    ...
    ultimateSkill: {
      ...
      icon: '🔥',
      energyCost: 60,
      description: 'Khai hỏa Laser Quỹ Đạo Chữ Thập phóng xuống bàn thiêu rụi và TIÊU DIỆT 2 CẶP Pokémon (+45đ), ban phước Bão Lửa Thái Dương Solar Overdrive x3 ĐIỂM SỐ trong 12s & cộng dồn +2s mỗi nước nối. PVP ĐẶC BIỆT: Thiêu đốt đối thủ gây Mù Khói Nhiệt 5s, Tê Liệt Quá Nhiệt 3.5s và trực tiếp CƯỚP 60 điểm đối thủ sang cho mình!',
